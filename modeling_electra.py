  ...
  def __init__(self,
    ...
    with tf.variable_scope(scope, default_name="electra"):
      ...
      with tf.variable_scope("encoder"):
        ...
        self.attention_entropy_loss = self.attn_maps
        self.pooled_output = self.sequence_output[:, 0]

        # use this to train attention supervision!!!!!!!!
    ...
    with tf.variable_scope("layer_%d" % layer_idx):
      with tf.variable_scope("attention"):
        ...
        with tf.variable_scope("self"):
          if layer_idx == 0: ## layer0 -> attention supervision
